            ...
            <div class="panel-body">
                <form class="form-inline" style="float: left;" action="" method="get">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="请输入查询关键字" name="keyword" value="{{Request::input('keyword')}}">
                    </div>
                    <button type="submit" class="btn btn-info">查询</button>
                </form>
                <a class="btn btn-success" href="#" role="button" style="float: right;" data-toggle="modal" data-target="#exampleModal" data-whatever="添加课程">添加课程</a>
            </div>
            <table class="table">
                <thead>
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="...">
                                ...
                                <a href="javascript:void(0);" class="btn btn-info" data-toggle="modal" data-target="#exampleModal" data-whatever="编辑课程">编辑</a>
